...
STYLE_PROMPTS = {
    ...
    "Kitchen": [
        {"name": "Modern Chef Kitchen", "prompt": "Redesign this exact room as a contemporary chef kitchen renovation. Keep the same room layout, dimensions, and camera perspective. Add a large waterfall quartz island, custom sage green cabinetry, professional-grade stainless appliances, herringbone backsplash, pendant lights, hardwood floors, and open shelving. Photorealistic renovation of this specific room."},
        {"name": "Luxury Tile Kitchen", "prompt": "Redesign this exact room as a luxury tiled kitchen renovation. Keep the same room layout, dimensions, and camera perspective. Apply stunning marble-look backsplash tiles, add shaker-style white cabinets, butcher block island, apron-front sink, brass fixtures, and pendant lighting. Photorealistic renovation of this specific room."},
        {"name": "Minimalist Modern Kitchen", "prompt": "Redesign this exact room as a seamless minimalist kitchen renovation. Keep the same room layout, dimensions, and camera perspective. Add handleless walnut and white cabinets, integrated appliances, waterfall marble island, hidden storage, under-cabinet LED lighting, and a statement range hood. Photorealistic renovation of this specific room."},
    ],
    "Living Room": [
        {"name": "Modern Luxe Living", "prompt": "Redesign this exact room as a modern luxury living room renovation. Keep the same room layout, dimensions, and camera perspective. Add a statement sectional sofa, marble coffee table, built-in entertainment center, floor-to-ceiling windows with sheer drapes, designer lighting fixtures, and a plush area rug. Photorealistic renovation of this specific room."},
        {"name": "Cozy Contemporary", "prompt": "Redesign this exact room as a cozy contemporary living room renovation. Keep the same room layout, dimensions, and camera perspective. Add warm wood paneling accent wall, comfortable oversized furniture, a stone fireplace, built-in bookshelves, layered textiles, and ambient lighting. Photorealistic renovation of this specific room."},
        {"name": "Scandinavian Minimal", "prompt": "Redesign this exact room as a Scandinavian minimalist living room renovation. Keep the same room layout, dimensions, and camera perspective. Add clean-lined furniture in neutral tones, light oak flooring, white walls, plants, natural textiles, and pendant lighting. Photorealistic renovation of this specific room."},
    ],
    "Bedroom": [
        {"name": "Serene Master Suite", "prompt": "Redesign this exact room as a serene master bedroom suite renovation. Keep the same room layout, dimensions, and camera perspective. Add a luxurious upholstered bed with tall headboard, matching nightstands, plush carpet, blackout drapes, accent lighting, and a reading nook. Photorealistic renovation of this specific room."},
        {"name": "Modern Boutique Hotel", "prompt": "Redesign this exact room as a modern boutique hotel-style bedroom renovation. Keep the same room layout, dimensions, and camera perspective. Add statement wallpaper, designer bed frame, velvet accents, pendant lighting, built-in closet system, and artwork. Photorealistic renovation of this specific room."},
        {"name": "Rustic Elegant Retreat", "prompt": "Redesign this exact room as a rustic elegant bedroom renovation. Keep the same room layout, dimensions, and camera perspective. Add reclaimed wood accent wall, four-poster bed, linen bedding, exposed beams, antique lighting, and natural fiber rugs. Photorealistic renovation of this specific room."},
    ],
    "Kids Room": [
        {"name": "Playful Adventure Room", "prompt": "Redesign this exact room as a playful adventure kids room renovation. Keep the same room layout, dimensions, and camera perspective. Add a loft bed with play area underneath, colorful storage cubbies, chalkboard wall, soft carpet, themed decor, and fun lighting. Photorealistic renovation of this specific room."},
        {"name": "Modern Montessori", "prompt": "Redesign this exact room as a modern Montessori-inspired kids room renovation. Keep the same room layout, dimensions, and camera perspective. Add floor bed, low shelving at child height, natural wood furniture, soft rugs, educational wall art, and calming neutral colors. Photorealistic renovation of this specific room."},
        {"name": "Whimsical Nursery", "prompt": "Redesign this exact room as a whimsical nursery renovation. Keep the same room layout, dimensions, and camera perspective. Add an elegant crib, changing station, plush rocker, soft pastel colors, decorative mobile, and dreamy lighting. Photorealistic renovation of this specific room."},
    ],
    "Home Office": [
        {"name": "Executive Home Office", "prompt": "Redesign this exact room as an executive home office renovation. Keep the same room layout, dimensions, and camera perspective. Add a large mahogany desk, leather executive chair, built-in bookshelves, sophisticated lighting, wood paneling, and professional decor. Photorealistic renovation of this specific room."},
        {"name": "Modern Creative Studio", "prompt": "Redesign this exact room as a modern creative studio home office renovation. Keep the same room layout, dimensions, and camera perspective. Add a standing desk, ergonomic chair, pegboard organization, plants, natural light optimization, and minimalist shelving. Photorealistic renovation of this specific room."},
        {"name": "Cozy Library Office", "prompt": "Redesign this exact room as a cozy library-style home office renovation. Keep the same room layout, dimensions, and camera perspective. Add floor-to-ceiling bookshelves, reading nook with window seat, antique desk, task lighting, and warm wood tones. Photorealistic renovation of this specific room."},
    ],
    # Functional Rooms
    "Garage": [
        {"name": "Ultimate Workshop", "prompt": "Redesign this exact space as an ultimate workshop garage renovation. Keep the same layout, dimensions, and camera perspective. Add epoxy-coated floors, wall-mounted tool organization, workbench with built-in storage, overhead storage racks, and bright LED lighting. Photorealistic renovation of this specific space."},
        {"name": "Modern Car Enthusiast", "prompt": "Redesign this exact space as a modern car enthusiast garage renovation. Keep the same layout, dimensions, and camera perspective. Add polished concrete floors, car lift, premium storage cabinets, display lighting, and branded signage. Photorealistic renovation of this specific space."},
        {"name": "Multi-Purpose Flex Space", "prompt": "Redesign this exact space as a multi-purpose flex garage renovation. Keep the same layout, dimensions, and camera perspective. Add rubber gym flooring, fold-down workbench, modular storage, climate control, and convertible space dividers. Photorealistic renovation of this specific space."},
    ],
    "Laundry Room": [
        {"name": "Modern Utility Room", "prompt": "Redesign this exact room as a modern utility laundry room renovation. Keep the same room layout, dimensions, and camera perspective. Add stacked front-load washer/dryer, quartz countertop for folding, upper cabinets, utility sink, and bright lighting. Photorealistic renovation of this specific room."},
        {"name": "Luxury Laundry Suite", "prompt": "Redesign this exact room as a luxury laundry suite renovation. Keep the same room layout, dimensions, and camera perspective. Add side-by-side premium appliances, marble countertops, custom cabinetry, chandelier lighting, and decorative tile backsplash. Photorealistic renovation of this specific room."},
        {"name": "Efficient Compact Design", "prompt": "Redesign this exact room as an efficient compact laundry room renovation. Keep the same room layout, dimensions, and camera perspective. Add space-saving stacked units, pull-out drying racks, wall-mounted ironing board, open shelving, and maximized storage. Photorealistic renovation of this specific room."},
    ],
    "Basement": [
        {"name": "Entertainment Lounge", "prompt": "Redesign this exact space as an entertainment lounge basement renovation. Keep the same layout, dimensions, and camera perspective. Add home theater setup, bar area, comfortable seating, soundproofing, mood lighting, and gaming zone. Photorealistic renovation of this specific space."},
        {"name": "Modern Guest Suite", "prompt": "Redesign this exact space as a modern guest suite basement renovation. Keep the same layout, dimensions, and camera perspective. Add bedroom area, bathroom, kitchenette, egress windows, and separate entrance feel. Photorealistic renovation of this specific space."},
        {"name": "Family Recreation Room", "prompt": "Redesign this exact space as a family recreation room basement renovation. Keep the same layout, dimensions, and camera perspective. Add play area, workout zone, craft corner, durable flooring, storage, and flexible furniture. Photorealistic renovation of this specific space."},
    ],
    "Mudroom": [
        {"name": "Organized Entry System", "prompt": "Redesign this exact room as an organized mudroom entry system renovation. Keep the same room layout, dimensions, and camera perspective. Add built-in lockers, bench seating with storage, coat hooks, shoe cubbies, and durable tile flooring. Photorealistic renovation of this specific room."},
        {"name": "Farmhouse Charm", "prompt": "Redesign this exact room as a farmhouse charm mudroom renovation. Keep the same room layout, dimensions, and camera perspective. Add shiplap walls, open cubbies, vintage hooks, wooden bench, basket storage, and decorative tiles. Photorealistic renovation of this specific room."},
        {"name": "Modern Minimalist Entry", "prompt": "Redesign this exact room as a modern minimalist mudroom renovation. Keep the same room layout, dimensions, and camera perspective. Add sleek built-in cabinets, hidden storage, floating bench, minimal hooks, and clean lines throughout. Photorealistic renovation of this specific room."},
    ],
    # Outdoor Areas
    "Patio": [
        {"name": "Modern Outdoor Living", "prompt": "Redesign this exact outdoor space as a modern outdoor living room patio renovation. Keep the same layout, dimensions, and camera perspective. Add a covered pergola, built-in L-shaped sofa, outdoor TV, ceiling fans, string lights, a stone fireplace, and composite decking. Photorealistic renovation of this specific space."},
        {"name": "Mediterranean Courtyard", "prompt": "Redesign this exact outdoor space as a Mediterranean courtyard patio renovation. Keep the same layout, dimensions, and camera perspective. Add terracotta tile flooring, an arched pergola with climbing vines, a central fountain, wrought iron furniture, and olive trees in terracotta pots. Photorealistic renovation of this specific space."},
        {"name": "Modern Rooftop Style", "prompt": "Redesign this exact outdoor space as a modern rooftop patio renovation. Keep the same layout, dimensions, and camera perspective. Add porcelain tile pavers, a sectional sofa, dining area with planter walls, built-in bar, ambient lighting, and artificial turf accent. Photorealistic renovation of this specific space."},
    ],
    "Pool Deck": [
        {"name": "Resort-Style Paradise", "prompt": "Redesign this exact outdoor space as a resort-style pool deck renovation. Keep the same layout, dimensions, and camera perspective. Add travertine pavers, an infinity-edge pool, built-in hot tub, outdoor kitchen area, tropical landscaping, lounge chairs, and string lights. Photorealistic renovation of this specific space."},
        {"name": "Modern Geometric", "prompt": "Redesign this exact outdoor space as a modern geometric pool deck renovation. Keep the same layout, dimensions, and camera perspective. Add large format concrete pavers, a rectangular pool with LED lighting, raised planters, built-in seating, and a pergola with retractable shade. Photorealistic renovation of this specific space."},
        {"name": "Natural Lagoon", "prompt": "Redesign this exact outdoor space as a natural lagoon pool deck renovation. Keep the same layout, dimensions, and camera perspective. Add flagstone pavers, a freeform pool with waterfall, mature landscaping, an outdoor fireplace, and a covered cabana. Photorealistic renovation of this specific space."},
    ],
    "Backyard": [
        {"name": "Entertainer's Paradise", "prompt": "Redesign this exact outdoor space as an entertainer's paradise backyard renovation. Keep the same layout, dimensions, and camera perspective. Add outdoor kitchen, dining pavilion, fire pit seating area, lush landscaping, pathway lighting, and water feature. Photorealistic renovation of this specific space."},
        {"name": "Family-Friendly Oasis", "prompt": "Redesign this exact outdoor space as a family-friendly backyard oasis renovation. Keep the same layout, dimensions, and camera perspective. Add lawn area, play structure, garden beds, covered seating, outdoor dining, and privacy hedges. Photorealistic renovation of this specific space."},
        {"name": "Zen Garden Retreat", "prompt": "Redesign this exact outdoor space as a zen garden backyard retreat renovation. Keep the same layout, dimensions, and camera perspective. Add meditation garden, koi pond, Japanese maple trees, stone pathways, bamboo fencing, and minimalist seating. Photorealistic renovation of this specific space."},
    ],
    "Outdoor Kitchen": [
        {"name": "Chef's Outdoor Paradise", "prompt": "Redesign this exact outdoor space as a chef's outdoor kitchen paradise renovation. Keep the same layout, dimensions, and camera perspective. Add built-in grill and smoker, pizza oven, bar seating, refrigeration, sink, and granite countertops under a covered structure. Photorealistic renovation of this specific space."},
        {"name": "Rustic BBQ Station", "prompt": "Redesign this exact outdoor space as a rustic BBQ station outdoor kitchen renovation. Keep the same layout, dimensions, and camera perspective. Add stone-clad grill island, wood-fired oven, reclaimed wood accents, pendant lighting, and farmhouse-style seating. Photorealistic renovation of this specific space."},
        {"name": "Modern Minimalist Kitchen", "prompt": "Redesign this exact outdoor space as a modern minimalist outdoor kitchen renovation. Keep the same layout, dimensions, and camera perspective. Add sleek stainless steel appliances, concrete countertops, integrated storage, LED lighting, and clean-lined furniture. Photorealistic renovation of this specific space."},
    ],
}
