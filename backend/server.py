...
STYLE_PROMPTS = {
    # Interior Rooms
    "Bathroom": [
        {"name": "Seamless Micro Quartz Spa", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this bathroom into a Seamless Micro Quartz Spa. Apply waterproof micro quartz coating to all shower walls, tub surround, and wet zone surfaces creating a perfectly smooth, jointless, waterproof shell. Use microcement on the remaining walls and floor in a warm taupe tone flowing continuously with no grout lines anywhere. Install a curbless walk-in shower with linear drain, floating vanity with integrated seamless basin, backlit mirror, matte black rainfall showerhead, and warm LED ambient lighting. The entire space should feel like one continuous sculptural surface. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Microcement & Rockscape", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this bathroom with smooth microcement on all walls and floors in a soft warm gray tone, completely seamless with no joints or grout visible anywhere. On one accent wall, create a dramatic rockscape feature wall made of sculpted textured stone-like forms with microaggregate finish — rough organic rock textures contrasting against the ultra-smooth microcement surroundings. Add a freestanding soaking tub, wall-mounted matte fixtures, recessed niches with LED backlighting, and a frameless glass shower partition. Moody ambient lighting highlighting the rockscape texture. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Venetian Plaster Luxury", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this bathroom with polished venetian plaster applied to all walls creating a luminous, depth-filled surface with subtle movement and sheen — absolutely no tiles or grout anywhere. Apply seamless micro quartz to the shower and wet zones for waterproof protection. Floors in continuous microcement in a complementary warm cream tone. Install premium matte brass fixtures, a floating double vanity with seamless integrated sinks, oversized backlit oval mirror, and elegant pendant lighting. Plush white towels, live greenery. The space should feel like a high-end European spa. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Kitchen": [
        {"name": "Seamless Microcement Kitchen", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this kitchen with continuous microcement surfaces throughout. WALLS: Smooth microcement in warm light gray on all walls with absolutely no tile backsplash — the microcement extends seamlessly from countertop to ceiling behind the range area. COUNTERTOPS: Seamless microcement countertops with waterfall edges on the island, integrated seamless sink. FLOORS: Continuous microcement flooring matching the walls in a seamless flow. CABINETS: Custom flat-panel cabinets in matte sage green with soft-close hardware. APPLIANCES: Professional range, panel-ready refrigerator. LIGHTING: Pendant lights over island, under-cabinet LED strips. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Micro Quartz & Rockscape Kitchen", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this kitchen with seamless micro quartz countertops and backsplash creating one continuous waterproof surface from counter to ceiling with no joints. On the main focal wall, add a dramatic rockscape accent wall made from sculpted microaggregate-finished forms that look like natural carved stone — a bold textural contrast against the smooth surfaces. Floors in continuous microcement. Cabinets in warm walnut wood with integrated handles. Matte black fixtures and hardware. Bright pendant lighting over the island. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Venetian Plaster Elegance", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this kitchen with venetian plaster on all visible walls creating a luminous smooth finish — no tile or grout anywhere. COUNTERTOPS: Seamless microcement countertops in a contrasting darker charcoal tone with waterfall island edges and integrated sink. BACKSPLASH: The venetian plaster extends seamlessly behind the range and counters. FLOORS: Continuous microterrazzo flooring with fine natural aggregates. CABINETS: Cream handleless push-open cabinets. APPLIANCES: Integrated panel-ready appliances. LIGHTING: Brass pendant lights, recessed ambient lighting. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Living Room": [
        {"name": "Seamless Microcement Living", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this living room with continuous microcement on all walls in a warm greige tone, flowing seamlessly into microcement flooring — no visible joints, seams, or grout anywhere. Add a rockscape accent wall behind the TV or fireplace area, made from sculpted textured forms with microaggregate finish creating dramatic organic rock textures. Modern furniture with clean lines: L-shaped sectional, marble-top coffee table, accent chairs. LED strip lighting highlighting the rockscape texture, recessed ceiling lights on dimmers, statement floor lamp. Built-in floating media console. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Venetian Plaster Lounge", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this living room with polished venetian plaster on all walls creating a luminous depth with subtle warm undertones — completely seamless with no tiles or grout. Floors in continuous microcement in a warm sand tone. On the fireplace wall or main focal wall, apply a deeper-toned burnished venetian plaster for contrast. Comfortable deep sofa, oversized ottoman, accent chairs. Warm recessed lighting on dimmers, elegant sconces flanking the focal wall, table lamps. Built-in bookshelves with seamless plaster backing. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Lime Wash & Microterrazzo", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this living room with soft lime wash finish on all walls in a pale warm white creating a subtle cloudy organic texture — no tiles or grout anywhere. Floors in continuous microterrazzo with fine natural stone aggregates creating an elegant terrazzo look without any joints or seams. Clean-lined light gray sofa, natural wood coffee table, statement lounge chair. Simple pendant lighting, arc floor lamp, sheer linen curtains diffusing natural light. Floating media console, minimal curated decor. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Bedroom": [
        {"name": "Seamless Venetian Suite", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this bedroom with polished venetian plaster on all walls in soft warm cream tones — completely seamless with zero tiles or grout. On the headboard wall, apply a deeper burnished venetian plaster in a rich warm tone as a full accent wall. Floors in continuous microcement in a matching warm palette. Built-in wardrobes with seamless plaster-finish doors flanking the bed. Bedside pendant lights, soft recessed ambient lighting on dimmers, blackout shades. Plush king bed with layered white and cream bedding, upholstered bench. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Microcement & Rockscape Retreat", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this bedroom with smooth microcement on all walls and floors in a soft warm gray tone flowing continuously — no tiles, no grout, no seams. Behind the bed, create a dramatic rockscape headboard wall made from sculpted textured forms with microaggregate finish, creating organic stone-like textures that serve as a stunning natural headboard feature. Floating nightstands, indirect LED lighting washing up the rockscape wall, warm recessed ceiling lights. Statement upholstered bed, high-quality white bedding, plush area rug. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Lime Wash Serenity", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this bedroom with soft lime wash plaster on all walls creating a gentle cloudy organic finish in warm white — no tiles or grout anywhere. Floors in continuous microcement in a light sand tone. Low-profile platform bed with integrated storage drawers, wall-mounted floating nightstands, concealed closet with seamless plaster-finish doors. Simple ceramic pendant lights, minimal recessed lights prioritizing natural light. Organic cotton bedding in earth tones, minimal curated decor, live greenery. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Kids Room": [
        {"name": "Playful Seamless Room", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this kids room with smooth microcement walls in a soft warm white and continuous microcement flooring — no tiles or grout anywhere. Add one colorful accent wall in a cheerful lime wash finish in a soft pastel tone. Loft bed with play area underneath, colorful storage cubbies in rounded soft-edge forms, chalkboard panel section on one wall, soft area rug over the seamless floor. Fun pendant lighting, LED strip accents. All surfaces smooth, seamless, and easy to clean. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Modern Montessori Seamless", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this kids room with smooth venetian plaster walls in calming neutral warm tones and continuous microcement flooring — no tiles or grout visible anywhere. Floor bed at ground level, low open shelving at child height along walls with seamless plaster finish, natural wood furniture, soft area rugs placed over the seamless floor. Educational wall art, simple pendant lighting, calming warm ambient glow. All surfaces continuous and safe with no sharp edges. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Whimsical Seamless Nursery", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this room into a seamless nursery with smooth venetian plaster on all walls in soft pastel tones — no tiles, no grout, just smooth continuous surfaces. Floors in warm microcement. Elegant crib against the main wall, changing station, plush nursing rocker, floating shelves with seamless plaster finish. Decorative mobile, dreamy ambient pendant lighting, soft LED glow strips. The entire room should feel soft, warm, and perfectly smooth. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Home Office": [
        {"name": "Executive Seamless Office", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this room into an Executive Home Office with polished venetian plaster on all walls in a rich warm charcoal tone — no tiles or grout. Floors in continuous microcement. On the main wall behind the desk, add a dramatic rockscape accent section made from sculpted microaggregate-finished forms creating a bold textured stone feature. Large executive desk, ergonomic leather chair, built-in floor-to-ceiling shelving with seamless plaster backing. Brass desk lamp, recessed ceiling lights, sconces flanking shelves. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Modern Seamless Studio", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this room into a Modern Creative Studio with smooth microcement on all walls in light warm gray and continuous microcement flooring — no tiles, no grout, completely seamless. Height-adjustable standing desk near window, ergonomic task chair. Open shelving system against microcement walls, floating seamless desk surface. Bright adjustable task lamp, LED strip behind monitors, recessed trimless ceiling lights. Clean, bright, and minimal with the seamless surfaces creating a calm focused environment. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Library Office with Venetian Plaster", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this room into a Library Office with venetian plaster in rich jewel tones on all walls — no tiles or grout anywhere. Floors in continuous microterrazzo with fine aggregates. Traditional writing desk with window view, comfortable upholstered desk chair, reading chair with side table. Floor-to-ceiling built-in bookshelves with seamless plaster backing and integrated lighting. Banker's lamp on desk, reading floor lamp, warm recessed lighting. The venetian plaster creates a rich luminous backdrop for the books and wood furnishings. Keep the exact same room shape, door positions, and window locations."},
    ],
    # Functional Rooms
    "Garage": [
        {"name": "Seamless Epoxy Workshop", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this garage into a workshop with seamless high-build epoxy floor coating in warm gray with a smooth satin finish — no tiles, no seams, one continuous surface. Walls finished in smooth microcement creating a clean modern backdrop. Wall-mounted metal slatwall panels for tools, overhead ceiling-mounted storage racks. 8-foot solid wood workbench with seamless microcement backsplash wall behind it. Bright 5000K LED shop lights across ceiling, task lighting over workbench. Keep the exact same space layout, door positions, and window locations."},
        {"name": "Metallic Epoxy Showroom", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this garage with high-gloss metallic epoxy flooring in graphite creating a stunning seamless reflective surface — no tiles, no joints. Walls in smooth microcement in dark charcoal. Premium modular cabinet system along walls with seamless countertops. Accent lighting under cabinets, bright even LED ceiling lighting. The seamless metallic floor creates a showroom-quality finish. Keep the exact same space layout, door positions, and window locations."},
        {"name": "Microcement Flex Space", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this garage into a multi-purpose flex space with continuous microcement flooring throughout — no tiles, no seams, completely smooth. Walls in matching lighter microcement. Designated zones: gym area with rubber mat overlay on the seamless floor, workshop area with fold-down workbench, clear parking zone. Bright overhead LEDs with zone controls, ceiling fan. The continuous microcement provides a clean unified base. Keep the exact same space layout, door positions, and window locations."},
    ],
    "Laundry Room": [
        {"name": "Seamless Micro Quartz Utility", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this laundry room with waterproof micro quartz coating on all walls and seamless microcement flooring — no tiles, no grout, completely seamless and waterproof. Stacked front-load washer/dryer, seamless microcement countertop for folding above, sleek upper cabinets, integrated utility sink with seamless surround. Bright clean LED lighting. All surfaces smooth, continuous, and easy to wipe clean. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Venetian Plaster Laundry Suite", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this laundry room with venetian plaster walls in a soft warm cream and continuous microcement floors — no tiles, no grout anywhere. Side-by-side premium appliances, seamless microcement countertops, custom floor-to-ceiling cabinetry with smooth plaster-finish doors. Elegant pendant lighting, seamless surfaces everywhere creating a luxury feel even in a utility space. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Compact Microcement Design", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this laundry room with smooth microcement on all walls and floors creating one continuous seamless surface — no tiles, no grout. Stacked washer/dryer to maximize space, pull-out drying rack, wall-mounted ironing board, open shelving with seamless microcement wall behind. Bright efficient LED lighting. Clean, minimal, and completely seamless. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Basement": [
        {"name": "Seamless Entertainment Lounge", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this basement into an entertainment lounge with microcement on all walls and continuous microcement flooring — no tiles, no grout, completely seamless. On the main media wall, create a rockscape accent feature made from sculpted textured forms with microaggregate finish. Home theater setup, bar area with seamless microcement counter, comfortable sectional seating, LED mood lighting washing up the rockscape wall. Keep the exact same space layout, stair positions, and window locations."},
        {"name": "Venetian Plaster Guest Suite", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this basement into a guest suite with venetian plaster on all walls in warm neutral tones and continuous microcement floors — no tiles, no grout anywhere. Defined bedroom area with comfortable bed, bathroom partition with seamless micro quartz waterproof surfaces, small kitchenette with seamless microcement counter. Warm recessed lighting, creating a welcoming space. Keep the exact same space layout, stair positions, and window locations."},
        {"name": "Microcement Recreation Room", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this basement into a recreation room with smooth microcement on all walls and continuous microcement flooring throughout — no tiles, no grout, no vinyl, just seamless surfaces. Zones for play, exercise with rubber mat over the seamless floor, and crafts. Built-in storage with seamless plaster-finish cabinets. Bright LED lighting, flexible modular furniture. Keep the exact same space layout, stair positions, and window locations."},
    ],
    "Mudroom": [
        {"name": "Seamless Microcement Entry", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this mudroom with durable microcement on all walls and continuous microcement flooring — no tiles, no grout, completely seamless and easy to clean. Built-in lockers with smooth plaster-finish doors, bench seating with hidden storage, sturdy coat hooks, shoe cubbies with seamless interiors. The continuous microcement makes cleaning muddy footprints effortless. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Venetian Plaster Entry", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this mudroom with venetian plaster on upper walls in a warm cream tone and durable microcement on the lower half and floors — no tiles, no grout, all seamless. Open storage cubbies with smooth plaster finish, sturdy hooks, floating bench with storage underneath. Warm pendant lighting. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Modern Seamless Minimal Entry", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this mudroom with smooth microcement throughout walls and floors in a consistent warm gray — no tiles, no grout, completely seamless. Sleek handleless built-in cabinets with seamless plaster-finish fronts, concealed storage, floating bench, minimal wall hooks. Clean, modern, and perfectly continuous surfaces. Keep the exact same room shape, door positions, and window locations."},
    ],
    # Outdoor Areas
    "Patio": [
        {"name": "Seamless Microterrazzo Patio", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this patio with continuous microterrazzo flooring featuring fine natural stone aggregates in a warm tone — no tiles, no pavers, no grout, one seamless outdoor surface. Covered pergola structure, built-in L-shaped sectional seating, gas fireplace feature with seamless microcement surround. String lights, ceiling fans, LED ambient lighting. The seamless microterrazzo creates an elegant resort-like ground surface. Keep the exact same space boundaries and access points."},
        {"name": "Microcement & Rockscape Patio", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this patio with continuous microcement flooring and walls — no tiles, no pavers, no grout. On one wall or column area, create a dramatic rockscape accent feature made from sculpted forms with microaggregate finish creating organic stone-like textures. Comfortable outdoor furniture, dining area, warm LED lighting highlighting the rockscape. The continuous microcement creates a clean modern base. Keep the exact same space boundaries and access points."},
        {"name": "Polished Seamless Outdoor Living", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this patio with seamless polished microcement flooring in a warm sand tone — no tiles, no pavers, no grout, one continuous surface. Modular sectional sofa, dining area with planter privacy walls finished in matching microcement, built-in bar counter with seamless microcement top. Ambient LED lighting, weather-resistant finishes. Keep the exact same space boundaries and access points."},
    ],
    "Pool Deck": [
        {"name": "Microterrazzo Pool Paradise", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this pool deck with continuous microterrazzo surfacing on all walking areas — no tiles, no pavers, no grout, a perfectly seamless non-slip surface with fine natural aggregates in a warm cream tone. Apply waterproof micro quartz coating on the pool coping and immediate wet zones. Add tropical landscaping, lounge chairs, string ambient lights, and a built-in outdoor seating area with seamless microcement bench surfaces. Keep the exact same pool shape, deck boundaries, and access points."},
        {"name": "Micro Quartz & Rockscape Resort", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this pool deck with waterproof micro quartz on all surfaces around the pool — no tiles, no pavers, no grout, completely seamless and waterproof. Create a rockscape feature wall or water feature surround made from sculpted textured forms with microaggregate finish creating dramatic natural stone textures. Modern lounge furniture, LED pool lighting, pergola with retractable shade. Keep the exact same pool shape, deck boundaries, and access points."},
        {"name": "Seamless Microcement Deck", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this pool deck with continuous microcement coating in a warm natural tone across all deck surfaces — no tiles, no pavers, no grout, one smooth seamless plane. Add built-in bench seating with seamless microcement surfaces, raised planter beds with microcement walls, outdoor shower with micro quartz surround. Ambient string lighting, modern clean lines. Keep the exact same pool shape, deck boundaries, and access points."},
    ],
    "Backyard": [
        {"name": "Microterrazzo & Rockscape Backyard", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this backyard with continuous microterrazzo pathways and patio areas — no tiles, no pavers, no grout, seamless walkways throughout. Create a dramatic rockscape feature wall or fire pit surround made from sculpted textured forms with microaggregate finish. Outdoor kitchen station with seamless microcement counters, lush perimeter landscaping, pathway LED lighting. Keep the exact same yard boundaries, fence lines, and access points."},
        {"name": "Seamless Microcement Living Space", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this backyard with continuous microcement on all hardscape surfaces — patio area, pathways, seating walls — no tiles, no pavers, no grout, everything seamless. Covered dining area with microcement table surface, fire pit with seamless surround, lawn play area preserved, privacy hedge plantings along borders. Warm pathway lighting. Keep the exact same yard boundaries, fence lines, and access points."},
        {"name": "Seamless Zen Retreat", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this backyard into a zen retreat with continuous microcement pathways — no tiles, no stone pavers, no grout, smooth seamless walking surfaces. Meditation garden area, water feature with seamless microcement basin, Japanese maple trees, bamboo accents, minimalist seamless bench seating. Subtle landscape lighting. Keep the exact same yard boundaries, fence lines, and access points."},
    ],
    "Outdoor Kitchen": [
        {"name": "Seamless Micro Quartz Chef's Station", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this outdoor kitchen with waterproof micro quartz on all counter surfaces, backsplash, and bar top — no tiles, no grout, completely seamless and waterproof. Built-in grill and smoker island with seamless microcement cladding, pizza oven, bar seating, outdoor refrigeration, prep sink integrated seamlessly. Microterrazzo flooring beneath. Keep the exact same space boundaries and access points."},
        {"name": "Microcement & Rockscape BBQ", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this outdoor kitchen with seamless microcement on all countertops and surfaces — no tiles, no grout. The grill island and surrounding structures clad in smooth microcement. On the back wall or feature area, create a rockscape surround made from sculpted textured forms with microaggregate finish creating a dramatic stone-like cooking alcove. Pendant lighting, dining seating area with seamless floor. Keep the exact same space boundaries and access points."},
        {"name": "Microterrazzo Modern Kitchen", "prompt": PRESERVATION_PREFIX + SEAMLESS_RULE + "Transform this outdoor kitchen with continuous microterrazzo flooring and seamless microcement countertops throughout — no tiles, no grout, no pavers. Sleek stainless steel built-in appliances, seamless integrated storage, LED strip lighting under counters, clean-lined outdoor furniture on the seamless floor. Modern minimal aesthetic with continuous surfaces. Keep the exact same space boundaries and access points."},
    ],
}
