...
STYLE_PROMPTS = {
    # Interior Rooms
    "Bathroom": [
        {"name": "Modern Spa Renovation", "prompt": PRESERVATION_PREFIX + "Transform this bathroom into a modern spa retreat. Apply natural stone tiles to walls and floors, replace fixtures with a freestanding soaking tub, rainfall shower head, and wooden vanity with vessel sink. Add warm LED lighting, live plants, and a large mirror. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Luxury Tile Renovation", "prompt": PRESERVATION_PREFIX + "Transform this bathroom with luxury tile work. Apply floor-to-ceiling marble-look porcelain tiles, add a frameless glass shower enclosure where the existing shower/tub is, install a floating vanity with brushed gold fixtures, and add recessed niches with accent lighting. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Seamless Microcement Renovation", "prompt": PRESERVATION_PREFIX + "Transform this bathroom with seamless microcement finishes. Apply continuous concrete-look microcement to walls and floor, upgrade to a wall-mounted toilet, add a floating oak vanity with round backlit mirror, and install industrial-chic pendant lights. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Kitchen": [
        {"name": "Modern Chef Kitchen", "prompt": PRESERVATION_PREFIX + "Transform this kitchen into a modern chef's space. Replace cabinets with custom sage green cabinetry, add a waterfall quartz island in the existing work area, upgrade to professional-grade stainless appliances, install herringbone backsplash, pendant lights, and hardwood floors. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Luxury Tile Kitchen", "prompt": PRESERVATION_PREFIX + "Transform this kitchen with luxury tile accents. Apply marble-look backsplash tiles, install shaker-style white cabinets, add a butcher block island, upgrade to an apron-front sink with brass fixtures, and add pendant lighting. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Minimalist Modern Kitchen", "prompt": PRESERVATION_PREFIX + "Transform this kitchen into a minimalist modern space. Install handleless walnut and white cabinets, integrate appliances behind panels, add a waterfall marble island, include under-cabinet LED lighting and a statement range hood. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Living Room": [
        {"name": "Modern Luxe Living", "prompt": PRESERVATION_PREFIX + "Transform this living room into a modern luxury space. Add a statement sectional sofa, marble coffee table, built-in entertainment center along the main wall, floor-to-ceiling drapes on existing windows, designer lighting fixtures, and a plush area rug. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Cozy Contemporary", "prompt": PRESERVATION_PREFIX + "Transform this living room into a cozy contemporary retreat. Add warm wood paneling to one accent wall, comfortable oversized furniture, a stone fireplace facade, built-in bookshelves, layered textiles, and ambient lighting. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Scandinavian Minimal", "prompt": PRESERVATION_PREFIX + "Transform this living room with Scandinavian minimalist style. Add clean-lined furniture in neutral tones, light oak flooring, white painted walls, plants, natural textiles, and modern pendant lighting. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Bedroom": [
        {"name": "Serene Master Suite", "prompt": PRESERVATION_PREFIX + "Transform this bedroom into a serene master suite. Add a luxurious upholstered bed with tall headboard against the main wall, matching nightstands, plush carpet flooring, blackout drapes on existing windows, accent lighting, and a cozy reading corner. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Modern Boutique Hotel", "prompt": PRESERVATION_PREFIX + "Transform this bedroom with boutique hotel style. Add statement wallpaper to the headboard wall, a designer bed frame, velvet accent furniture, pendant lighting, built-in closet system, and curated artwork. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Rustic Elegant Retreat", "prompt": PRESERVATION_PREFIX + "Transform this bedroom with rustic elegance. Add a reclaimed wood accent wall behind the bed, four-poster bed frame, linen bedding, decorative ceiling beams, antique-style lighting, and natural fiber rugs. Keep the exact same room shape, door positions, and window locations."},
    ],
    "Kids Room": [
    ...
    "Home Office": [
        {"name": "Executive Home Office", "prompt": PRESERVATION_PREFIX + "Transform this room into an executive home office. Add a large mahogany desk facing the window, leather executive chair, built-in bookshelves along one wall, sophisticated task and ambient lighting, wood paneling accents, and professional decor. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Modern Creative Studio", "prompt": PRESERVATION_PREFIX + "Transform this room into a modern creative studio. Add a standing desk near the window for natural light, ergonomic chair, pegboard wall organization, plants throughout, minimalist floating shelves, and focused task lighting. Keep the exact same room shape, door positions, and window locations."},
        {"name": "Cozy Library Office", "prompt": PRESERVATION_PREFIX + "Transform this room into a cozy library office. Add floor-to-ceiling bookshelves along the main walls, a reading nook at the window, antique-style desk, warm task lighting, and rich wood tones throughout. Keep the exact same room shape, door positions, and window locations."},
    ],
    # Functional Rooms
    "Garage": [
        {"name": "Ultimate Workshop", "prompt": PRESERVATION_PREFIX + "Transform this garage into an ultimate workshop. Apply epoxy coating to the existing floor, add wall-mounted tool organization systems, install a sturdy workbench with storage, add overhead storage racks, and upgrade to bright LED shop lighting. Keep the exact same space layout, door positions, and window locations."},
        {"name": "Modern Car Enthusiast", "prompt": PRESERVATION_PREFIX + "Transform this garage for a car enthusiast. Polish the concrete floor, add a car lift in the center, install premium wall-mounted storage cabinets, add display lighting for vehicles, and include branded automotive signage. Keep the exact same space layout, door positions, and window locations."},
        {"name": "Multi-Purpose Flex Space", "prompt": PRESERVATION_PREFIX + "Transform this garage into a multi-purpose flex space. Install rubber gym flooring, add a fold-down workbench on one wall, include modular storage systems, and add convertible space dividers for different activities. Keep the exact same space layout, door positions, and window locations."},
    ],
    "Laundry Room": [
