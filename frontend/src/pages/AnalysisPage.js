...
const ROOM_ANALYSIS_DATA = {
  Bathroom: {
    conditions: [
      ...
      { icon: Paintbrush, text: "Grout lines may harbor mold or mildew", severity: "significant" },
    ...
    improvements: [
      { icon: Shield, text: "Install waterproof membrane behind all wet surfaces" },
      { icon: Paintbrush, text: "Upgrade to large-format tiles or seamless microcement" },
      { icon: Zap, text: "Add layered lighting with dimmers and task lights" },
      { icon: Thermometer, text: "Consider heated flooring for comfort" },
      { icon: Wrench, text: "Replace fixtures with water-efficient models" },
    ],
  },
  Kitchen: {
    conditions: [
    ...
    improvements: [
      { icon: Wrench, text: "Reface or replace cabinets with soft-close hardware" },
      { icon: Paintbrush, text: "Install durable quartz or granite countertops" },
      { icon: Zap, text: "Upgrade to energy-efficient appliances" },
      { icon: Lightbulb, text: "Add under-cabinet LED lighting and pendants" },
  ...
  "Living Room": {
    ...
    improvements: [
      { icon: Paintbrush, text: "Add accent wall with texture or wallpaper" },
      { icon: Lightbulb, text: "Install dimmable lighting with multiple zones" },
      { icon: Layout, text: "Create defined zones for activities" },
      { icon: Wrench, text: "Refinish or replace flooring" },
      { icon: Zap, text: "Add built-in storage and entertainment center" },
    ],
  },
  Bedroom: {
    conditions: [
    ...
    improvements: [
      ...
      { icon: Layout, text: "Install built-in wardrobes or closet system" },
      { icon: Paintbrush, text: "Create upholstered accent wall behind bed" },
      { icon: Thermometer, text: "Add blackout shades and sound insulation" },
      { icon: Wrench, text: "Install plush carpet or refinish hardwood" },
    ],
  },
  "Home Office": {
    conditions: [
  ...
  Garage: {
    ...
    improvements: [
      { icon: Paintbrush, text: "Apply professional epoxy floor coating" },
      { icon: Layout, text: "Install wall-mounted organization systems" },
      { icon: Lightbulb, text: "Upgrade to bright LED shop lighting" },
      { icon: Wrench, text: "Add workbench with built-in storage" },
      { icon: Zap, text: "Consider insulation and climate control" },
    ],
  },
  Patio: {
    conditions: [
    ...
    improvements: [
      { icon: Paintbrush, text: "Install new pavers or composite decking" },
      ...
      { icon: Zap, text: "Add outdoor electrical and entertainment" },
    ],
  },
  "Pool Deck": {
    conditions: [
    ...
    improvements: [
      { icon: Paintbrush, text: "Install cool-touch travertine or pavers" },
      { icon: Wrench, text: "Improve drainage with proper grading" },
      { icon: Layout, text: "Add cabana or pergola for shade" },
      { icon: Lightbulb, text: "Upgrade pool lighting to color LED" },
      { icon: Zap, text: "Build outdoor kitchen or bar area" },
    ],
  },
  Backyard: {
    conditions: [
    ...
    improvements: [
      { icon: Paintbrush, text: "Professional landscaping with native plants" },
      { icon: Layout, text: "Create patio, fire pit, and lawn zones" },
      { icon: Lightbulb, text: "Add pathway and landscape lighting" },
      { icon: Droplets, text: "Install smart irrigation system" },
      { icon: Wrench, text: "Build fire pit or outdoor fireplace" },
    ],
  },
};
